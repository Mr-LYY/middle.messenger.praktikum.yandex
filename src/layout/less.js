...
(function (global, factory) {
  ...
  Color.prototype = Object.assign(new Node(), {
    type: 'Color',
    luma() {
      let r = this.rgb[0] / 255; let g = this.rgb[1] / 255; let
        b = this.rgb[2] / 255;
    ...
    toHSL() {
      const r = this.rgb[0] / 255; const g = this.rgb[1] / 255; const b = this.rgb[2] / 255; const
        a = this.alpha;
  ...
  Selector.prototype = Object.assign(new Node(), {
    ...
    createEmptySelectors() {
      const el = new Element('', '&', false, this._index, this._fileInfo); const
  ...
  Declaration.prototype = Object.assign(new Node(), {
    ...
    eval(context) {
      let mathBypass = false; let prevMath; let { name } = this; let evaldValue; let
        { variable } = this;
  ...
  AtRule.prototype = Object.assign(new Node(), {
    ...
    outputRuleset(context, output, rules) {
      ...
      // Non-compressed
      const tabSetStr = `\n${Array(context.tabLevel).join('  ')}`; const
  ...
  Operation.prototype = Object.assign(new Node(), {
    ...
    eval(context) {
      let a = this.operands[0].eval(context); let b = this.operands[1].eval(context); let
        op;
          ...
          for (m = 0; m < candidates.length; m++) {
            ...
            if ((candidate === defNone) || (candidate === defaultResult)) {
              try {
                ...
                throw {
                  message: e.message, index: this.getIndex(), filename: this.fileInfo().filename, stack: e.stack,
                };
              }
            }
          }
  ...
  const AbstractPluginLoader = /** @class */ (function () {
    ...
    AbstractPluginLoader.prototype.evalPlugin = function (contents, context, imports, pluginOptions, fileInfo) {
      let loader; let registry; let pluginObj; let localModule; let pluginManager; let filename; let
        result;
  ...
  const Visitor = /** @class */ (function () {
    ...
    Visitor.prototype.flatten = function (arr, out) {
      ...
      let cnt; let i; let item; let nestedCnt; let j; let
        nestedItem;
  ...
  const ImportSequencer = /** @class */ (function () {
    ...
    ImportSequencer.prototype.addImport = function (callback) {
      const importSequencer = this; const
        importItem = {
          callback,
          args: null,
          isReady: false,
  ...
  ImportVisitor.prototype = {
    ...
    processImportNode(importNode, context, importParent) {
      ...
      if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
        ...
        const onImported = this.onImported.bind(this, evaldImportNode, context); const
    ...
    onImported(importNode, context, e, root, importedAtRoot, fullPath) {
      ...
      const importVisitor = this; const inlineCSS = importNode.options.inline; const { isPlugin } = importNode.options; const isOptional = importNode.options.optional; const
  ...
  const ExtendFinderVisitor = /** @class */ (function () {
    ...
    ExtendFinderVisitor.prototype.visitRuleset = function (rulesetNode, visitArgs) {
      ...
      for (i = 0; i < paths.length; i++) {
        const selectorPath = paths[i]; const selector = selectorPath[selectorPath.length - 1]; const
  ...
  const ProcessExtendsVisitor = /** @class */ (function () {
    ...
    ProcessExtendsVisitor.prototype.extendSelector = function (matches, selectorPath, replacementSelector, isVisible) {
      ...
      let currentSelectorPathIndex = 0; let currentSelectorPathElementIndex = 0; let path = []; let matchIndex; let selector; let firstElement; let match; let
        newElements;
  ...
  const string = {
    ...
    escape(str) {
      return new Anonymous(encodeURI(str.value).replace(/=/g, '%3D').replace(/:/g, '%3A').replace(/#/g, '%23')
        .replace(/;/g, '%3B')
        .replace(/\(/g, '%28')
        .replace(/\)/g, '%29'));
    },
  ...
  function SourceMapOutput(environment) {
    const SourceMapOutput = /** @class */ (function () {
      ...
      SourceMapOutput.prototype.add = function (chunk, fileInfo, index, mapLines) {
        ...
        let lines; let sourceLines; let columns; let sourceColumns; let
          i;
  ...
  function ImportManager(environment) {
    ...
    const ImportManager = /** @class */ (function () {
      ...
      ImportManager.prototype.push = function (path, tryAppendExtension, currentFileInfo, importOptions, callback) {
        const importManager = this; const
  ...
  function lessRoot(environment, fileManagers) {
    let sourceMapOutput; let sourceMapBuilder; let parseTree; let
      importManager;
    ...
    function loadStyles(modifyVars) {
      ...
      for (let i = 0; i < styles.length; i++) {
        ...
        if (style.type.match(typePattern)) {
          ...
          less.render(lessText, instanceOptions, bind((style, e, result) => {
            if (e) {
              errors.add(e, 'inline');
            } else {
              style.type = 'text/css';
