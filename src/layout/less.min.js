...
!(function (e, t) {
    ...
    U.prototype = Object.assign(new u(), {
        ...
        genCSS: function (e, t) {
            this.debugInfo &&
                t.add(B(e, this), this.fileInfo(), this.getIndex()),
                t.add(this.value);
        },
        isSilent: function (e) {
    ...
    Z.prototype = Object.assign(new u(), {
        ...
        find: function () {
            if (this.rules)
                return K.prototype.find.apply(this.rules[0], arguments);
        },
        rulesets: function () {
        ...
        eval: function (e) {
            ...
            return (
                (i = n(i, this.variableRegex, function (i, n) {
                    var r = new oe('@' + n, t.getIndex(), t.fileInfo()).eval(
                        e,
                        !0,
                    );
                ...
                (i = n(i, this.propRegex, function (i, n) {
                    var r = new ae('$' + n, t.getIndex(), t.fileInfo()).eval(
                        e,
                        !0,
                    );
                    return r instanceof ue ? r.value : r.toCSS();
        ...
        doEval: function (e) {
            ...
            return this.root
                ? ((t = new K(null, k(this.root.rules))).evalImports(e),
                  this.features
                      ? new he(t.rules, this.features.value)
                      : t.rules)
                : [];
        },
    });
    ...
    pe.prototype = Object.assign(new u(), {
        evaluateJavaScript: function (e, t) {
            ...
            e = e.replace(/@\{([\w-]+)\}/g, function (e, i) {
                return n.jsify(
                    new oe('@' + i, n.getIndex(), n.fileInfo()).eval(t),
                );
            });
            try {
    ...
    de.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            return this.value.eval
                ? new de(this.key, this.value.eval(e))
                : this;
        },
        genCSS: function (e, t) {
            t.add(this.key + '='),
        ...
        $e = (function () {
            ...
            return (
                ...
                (e.prototype.isElementValuesEqual = function (e, t) {
                    ...
                    if (
                        ((e = e.value), (t = t.value), e instanceof Ce.Selector)
                    ) {
                        if (
            ...
            return {
                ...
                parse: function (r, o, a) {
                    ...
                    (u || (a && a.banner)) &&
                        ...
                        ((h = i.contentsIgnoredChars)[n.filename] =
                            h[n.filename] || 0),
                ...
                parsers: (r = {
                    ...
                    entities: {
                        ...
                        keyword: function () {
                            ...
                            if (e)
                                return (
                                    Ce.Color.fromKeyword(e) || new Ce.Keyword(e)
                                );
                        },
                        call: function () {
                            var e,
                        ...
                        assignment: function () {
                            ...
                            if ((s.save(), (e = s.$re(/^\w+(?=\s?=)/i))))
                                if (s.$char('=')) {
                                    if ((t = r.entity()))
                                        return (
                                            s.forget(), new Ce.Assignment(e, t)
                                        );
                                    s.restore();
                                } else s.restore();
                            else s.restore();
                        ...
                        color: function () {
                            ...
                            if (
                                ...
                                return (
                                    s.forget(), new Ce.Color(e[1], void 0, e[0])
                                );
                            s.restore();
                        },
                            ...
                            for (s.save(); ; ) {
                                ...
                                if (
                                    (e
                                        ...
                                        : (g = u),
                                    g &&
                                        (g instanceof Ce.Variable ||
                                            g instanceof Ce.Property))
                                )
                                    if (s.$char(':')) {
                                        if (
                                            (p.length > 0 &&
                        ...
                        if ('.' !== u && '#' !== u && '&' !== u && ':' !== u)
                            if (
                                ...
                                if (t && (this.end() || i))
                                    return (
                                        s.forget(),
                                        new Ce.Declaration(e, t, r, o, l, n)
                                    );
                                s.restore();
                            } else s.restore();
                    },
                    ...
                    sub: function () {
                        ...
                        if ((s.save(), s.$char('(')))
                            return (e = this.addition()) && s.$char(')')
                                ? (s.forget(),
                                  ((t = new Ce.Expression([e])).parens = !0),
                                  t)
                    ...
                    operand: function () {
                        ...
                        return (
                            e &&
                                ((i.parensInOp = !0), (i = new Ce.Negative(i))),
                            i
                        );
                    },
                    expression: function () {
                        ...
                        do {
                            (e = this.comment())
                                ...
                                : ((e =
                                      this.addition() ||
                                      this.entity()) instanceof Ce.Comment &&
                                      (e = null),
                                  e &&
                                      (i.push(e),
                                      s.peek(/^\/[\/*]/) ||
                                          ((t = s.$char('/')) &&
                                              i.push(new Ce.Anonymous(t, n)))));
                        } while (e);
                    ...
                    ruleProperty: function () {
                        ...
                        if (o)
                            return (i = [new Ce.Keyword(o[1])]), s.forget(), i;
                        function a(e) {
                            var t = s.i,
                                n = s.$re(e);
    ...
    for (var et in Ye)
        Ye.hasOwnProperty(et) && (Xe[et] = Xe.bind(null, Ye[et]));
    var tt = function (e) {
        ...
        ft = function (e) {
            ...
            return (
                ...
                H.addMultiple(
                    (function (e) {
                        var t = function (e, t) {
                            return new ce(t, e.index, e.currentFileInfo).eval(
                                e.context,
                            );
                        };
                        return {
            ...
            ((n = Object.keys(n).map(function (e) {
                ...
                return (
                    t instanceof Ce.Value ||
                        (t instanceof Ce.Expression ||
                            (t = new Ce.Expression([t])),
                        (t = new Ce.Value([t]))),
                                    ...
                                    ? ((this._sourceMapRootpath =
                                      ...
                                      '/' !==
                                          this._sourceMapRootpath.charAt(
                                              this._sourceMapRootpath.length -
                                                  1,
                                          ) && (this._sourceMapRootpath += '/'))
                                    : (this._sourceMapRootpath = ''),
